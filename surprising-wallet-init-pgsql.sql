...
CREATE TABLE "account_transaction" (
 ...
 "confirm_num" bigint NOT NULL,
 "biz" int NOT NULL,
 "status" SMALLINT DEFAULT 0,
 "create_date" timestamp DEFAULT CURRENT_TIMESTAMP,
 "update_date" timestamp DEFAULT '1970-01-01 00:00:00',
 PRIMARY KEY ("id"),
 UNIQUE ("tx_id")
);
...
CREATE TABLE "bat_withdraw_record" (
 ...
 "biz" int NOT NULL,
 "withdraw_id" varchar(128) NOT NULL DEFAULT '',
 "status" SMALLINT DEFAULT 0,
 "create_date" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 "update_date" timestamp NOT NULL DEFAULT '1970-01-01 00:00:00',
 PRIMARY KEY ("id"));
...
CREATE TABLE "bch_utxo_transaction" (
 ...
 "status" SMALLINT DEFAULT 0,
 "spent_tx_id" varchar(128) NOT NULL DEFAULT '',
 "create_date" timestamp DEFAULT CURRENT_TIMESTAMP,
 "update_date" timestamp DEFAULT '1970-01-01 00:00:00',
 PRIMARY KEY ("id"),
 UNIQUE ("tx_id", "seq"));
...
CREATE TABLE "best_block_height" (
 ...
 "create_date" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 "update_date" timestamp NOT NULL DEFAULT '1970-08-18 00:00:00',
 PRIMARY KEY ("id"));
...
CREATE TABLE "doge_address" (
 ...
 "status" SMALLINT DEFAULT 0,
 "create_date" timestamp DEFAULT CURRENT_TIMESTAMP,
 "update_date" timestamp DEFAULT '1970-08-18 00:00:00',
 PRIMARY KEY ("id"),
 UNIQUE ("user_id", "address")
);
