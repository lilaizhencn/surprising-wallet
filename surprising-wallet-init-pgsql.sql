...
SELECT setval(pg_get_serial_sequence('best_block_height', 'id'), 3, true);
SELECT setval(pg_get_serial_sequence('currency_balance', 'id'), 3, true);
SELECT setval(pg_get_serial_sequence('btc_address', 'id'), 1, true);
SELECT setval(pg_get_serial_sequence('wallet_multisig_config', 'id'), 3, true);
