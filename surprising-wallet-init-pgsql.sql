...
ALTER TABLE doge_utxo_transaction
  ADD PRIMARY KEY (id),
  ADD UNIQUE (tx_id, seq);

CREATE INDEX idx_doge_utxo_available
  ON doge_utxo_transaction (status, confirm_num, spent_tx_id);
CREATE INDEX idx_doge_utxo_address
...
ALTER TABLE doge_withdraw_transaction
  ADD PRIMARY KEY (id);

CREATE INDEX idx_doge_withdraw_transaction_tx_id
  ON doge_withdraw_transaction (tx_id);
CREATE INDEX idx_doge_withdraw_transaction_status
...
CREATE TABLE bch_utxo_transaction (LIKE btc_utxo_transaction INCLUDING DEFAULTS INCLUDING IDENTITY);
ALTER TABLE bch_utxo_transaction ADD PRIMARY KEY(id), ADD UNIQUE(tx_id,seq);
CREATE INDEX idx_bch_utxo_available ON bch_utxo_transaction(status,confirm_num,spent_tx_id);
CREATE INDEX idx_bch_utxo_address ON bch_utxo_transaction(address);
...
CREATE TABLE bch_withdraw_transaction (LIKE btc_withdraw_transaction INCLUDING DEFAULTS INCLUDING IDENTITY);
ALTER TABLE bch_withdraw_transaction ADD PRIMARY KEY(id);
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'wallet') THEN
    ...
    ALTER TABLE doge_utxo_transaction OWNER TO wallet;
    ALTER TABLE doge_withdraw_record OWNER TO wallet;
    ALTER TABLE doge_withdraw_transaction OWNER TO wallet;
    ALTER TABLE bch_address OWNER TO wallet;
    ALTER TABLE bch_utxo_transaction OWNER TO wallet;
    ALTER TABLE bch_withdraw_record OWNER TO wallet;
    ALTER TABLE bch_withdraw_transaction OWNER TO wallet;
