...
final class JsonRpcDevFaucetClient implements DevFaucetRpcClient {
    ...
    JsonRpcDevFaucetClient(DevFaucetProperties properties, ObjectMapper objectMapper) {
    ...
    static String encodeTransfer(String address, BigInteger atomicAmount) {
