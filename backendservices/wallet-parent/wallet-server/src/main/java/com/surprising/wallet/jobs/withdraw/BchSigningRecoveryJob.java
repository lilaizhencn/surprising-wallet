...
@Component public class BchSigningRecoveryJob{
    ...
    public BchSigningRecoveryJob(ChainJdbcRepository repo,AssetRoutingService assetRoutingService,WalletRuntimeConfigService runtimeConfigService){this.repo=repo;this.assetRoutingService=assetRoutingService;this.runtimeConfigService=runtimeConfigService;}
