package com.surprising.common.mybatis.sharding.data;
...
public interface SelectRepository<T, U, K> {
     ...
     * @return
     */
    Optional<T> selectById(@Param("id") K id, @Param("shardTable") ShardTable shardTable);
     ...
     * @return 分页记录列表
     */
    Optional<T> selectOneByExample(@Param("example") U example, @Param("shardTable") ShardTable shardTable);
