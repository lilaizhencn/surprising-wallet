...
| EVM L2 / L3 | ARBITRUM, OPTIMISM, BASE, AVAX_C, CELO, WORLD_CHAIN, INK, TAIKO, SONEIUM, MODE, LISK, KATANA, MEGAETH, X_LAYER, DEGEN, ROBINHOOD_CHAIN, ETHERLINK | Hardhat fork | Sepolia L2、Avalanche Fuji、Celo Sepolia、World Chain Sepolia、Ink Sepolia、Taiko Hoodi、Soneium Minato、Mode Sepolia、Lisk Sepolia、Katana Bokuto、MegaETH Carrot、X Layer Testnet、Degen Chain Mainnet、Robinhood Chain Testnet、Etherlink Shadownet |
