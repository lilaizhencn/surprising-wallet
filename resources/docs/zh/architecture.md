...
| EVM | ETH, BNB, POLYGON, BERACHAIN, GNOSIS | Hardhat fork | Sepolia、BSC testnet、Amoy、Berachain Bepolia、Gnosis Chiado |
| EVM L2 | ARBITRUM, OPTIMISM, BASE, AVAX_C, CELO | Hardhat fork | Sepolia L2、Avalanche Fuji、Celo Sepolia |
