...
public class EthECKey implements Serializable {
    ...
    public static void main(String[] args) {
        System.out.println("Sender is\t\t: " + Hex.toHexString(new EthECKey().getAddress()));
    }
     ...
     * All private key operations will use the provider.
     */
    public EthECKey(Provider provider, @Nullable PrivateKey privKey, ECPoint pub) {
        this.provider = provider;
     ...
     * BouncyCastle will be used as the Java Security Provider
     */
    public EthECKey(@Nullable BigInteger priv, ECPoint pub) {
        this(
    ...
    public EthECKey decompress() {
        if (!pub.isCompressed()) {
            ...
            return new EthECKey(provider, privKey, decompressPoint(pub));
        }
    }
    ...
    public EthECKey compress() {
        if (pub.isCompressed()) {
            ...
            return new EthECKey(provider, privKey, compressPoint(pub));
        }
    }
    ...
    public byte[] getNodeId() {
        if (nodeId == null) {
            nodeId = pubBytesWithoutFormat(pub);
        }
        return nodeId;
    }
    ...
    public ECDSASignature sign(byte[] messageHash) {
        ...
        int recId = -1;
        byte[] thisKey = pub.getEncoded(/* compressed */ false);
        for (int i = 0; i < 4; i++) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof EthECKey)) {
            return false;
        }
    ...
    public static class MissingPrivateKeyException extends RuntimeException {
        private static final long serialVersionUID = -4385810267187205086L;
    }
