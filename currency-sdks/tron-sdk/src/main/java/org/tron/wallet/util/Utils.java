...
public class Utils {
  ...
  public static String printAccount(Account account) {
    String result = "";
    result += "address: ";
    result += TronWalletApi.encode58Check(account.getAddress().toByteArray());
    result += "\n";
    ...
    if (account.getVotesCount() > 0) {
      for (Vote vote : account.getVotesList()) {
        ...
        result += "\n";
        result += "  vote_address: ";
        result += TronWalletApi.encode58Check(vote.getVoteAddress().toByteArray());
        result += "\n";
        result += "  vote_count: ";
...
//  }
  ...
  public static String printWitness(Witness witness) {
    String result = "";
    result += "address: ";
    result += TronWalletApi.encode58Check(witness.getAddress().toByteArray());
    result += "\n";
    result += "voteCount: ";
  ...
  public static String printProposal(Proposal proposal) {
    ...
    for (ByteString address : proposal.getApprovalsList()) {
      result += TronWalletApi.encode58Check(address.toByteArray());
      result += "\n";
    }
    result += "]";
    return result;
  ...
  public static String printAssetIssue(AssetIssueContract assetIssue) {
    ...
    result += TronWalletApi.encode58Check(assetIssue.getOwnerAddress().toByteArray());
    result += "\n";
    result += "name: ";
    ...
    try {
      ...
      switch (contract.getType()) {
        ...
        case UpdateAssetContract:
          ...
          result += "owner_address: ";
          result += TronWalletApi.encode58Check(updateAssetContract.getOwnerAddress().toByteArray());
          result += "\n";
          result += "description: ";
        ...
        case CreateSmartContract:
          ...
          result += TronWalletApi.encode58Check(newContract.getContractAddress().toByteArray());
          result += "\n";
          break;
  ...
  public static String printTransactionInfo(TransactionInfo transactionInfo) {
    ...
    result += "\n";
    result += TronWalletApi.encode58Check(transactionInfo.getContractAddress().toByteArray());
    result += "\n";
    result += "logList: ";
    result += "\n";
  ...
  public static String printBlockRow(BlockHeader.raw raw) {
    ...
    result += TronWalletApi.encode58Check(raw.getWitnessAddress().toByteArray());
    result += "\n";
