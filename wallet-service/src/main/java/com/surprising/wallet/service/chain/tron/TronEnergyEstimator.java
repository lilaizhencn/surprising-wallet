...
public class TronEnergyEstimator {
    public static final long DEFAULT_TRX_TRANSFER_BANDWIDTH = 268L;    public static final long DEFAULT_TRC20_ENERGY = 95_000L;    public long estimateBandwidth(boolean tokenTransfer) {
